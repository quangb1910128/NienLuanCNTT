...
$qld1 = $qldiem->hienthidiem1($_REQUEST['mshs']);
$qld2 = $qldiem->hienthidiem2($_REQUEST['mshs']);
?>
    ...
    <main class="container">
        <div class="row">
            ...
            <div class="col-xs-8">
                <br><br>
                <div>
                    <p>Kết quả học tập của <b><?php echo $qldiem->gettenhs($_REQUEST['mshs']) ?></b> trong học kỳ 1</p>
                </div>
                <div class="row">
                    <div class="col-xs-6">
                ...
                <br>
                <div>
                    <p?>Kết quả học tập của <b><?php echo $qldiem->gettenhs($_REQUEST['mshs']) ?></b> trong học kỳ 2</p>
                </div>
                <div class="row">
                    <div class="col-xs-6">
                        <table class="table table-bordered table-striped">
                ...
                <br>
                <div>
                    <p?>Kết quả học tập cả năm của <b><?php echo $qldiem->gettenhs($_REQUEST['mshs']) ?></b></p>
                </div>
                <div class="row">
                    <div class="col-xs-6">
                        <table class="table table-bordered table-striped">
