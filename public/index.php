				...
				<div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
					<form action="#" method="post">
						<div class="divider d-flex align-items-center my-4">
							<p class="lead fw-normal text-center fw-bold mb-0 me-3">Login</p>
						</div>
						...
						<div class="d-flex justify-content-between align-items-center">
							...
							<div class="form-check mb-0">
								...
								<input  class="form-check-input" type="radio" name="quyen" value="tkhs" checked>Học sinh
								</label>
									&emsp;&emsp;
								<label class="radio-inline form-radio-label">
								<input class="form-check-input" type="radio" name="quyen" value="tkgv">Giáo viên
								</label>
							</div>
						</div>
